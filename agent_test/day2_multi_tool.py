...
def load_model():
    ...
    # 避免你前面看到的 generation flags warning
    # 有些模型自带 generation_config 字段，do_sample=False 时这些字段会触发提示
...
# 6) 单轮 Agent
# ----------------------------
def run_agent(tokenizer, model, user_query: str):
    # Step 1: 工具规划
    planning_messages = [
    ...
    # Step 2: direct_answer 分支
    if tool_name == "direct_answer":
        print("\n=== FINAL ANSWER ===")
        print(args.get("answer", ""))
        return
